<?php      //header("Expires: Mon, 26 Jul 1997 05:00:00 GMT");              // Date in the past
       ...
       if($hay_sesion )
       {
			...
			$query="SELECT SESSIONID,NAME,BALANCE,USERTYPE,SCHOOLTYPE,TUTORLEVEL, EMAIL FROM USERS2 WHERE USERCODE='$USER_CODE'";
			...
			$TUTORLEVEL=genesis_result($resultado,6);$_SESSION['TUTORLEVEL']=$TUTORLEVEL;
			$USER_EMAIL=genesis_result($resultado,7);$_SESSION['EMAIL']=$USER_EMAIL;			
